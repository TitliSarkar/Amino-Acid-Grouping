...
## Code for generating TSR keys from pdb files (without amino acid grouping)
## Input : .pdb files
## Output: .triplets and .keys files 
##			.keys files contains key - freqofthekey for each protein
##			.triplets files contains details of each key and corresponding TSR for each protein
...
def parallelcode(fileName, chain):
    ...
    outFile2 = open(data_dir+subdir+fileName+".keys_29_35", "w")
    fileTriplets = open(data_dir+subdir+fileName+".triplets_29_35","w")
